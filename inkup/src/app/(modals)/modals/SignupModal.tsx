...
export default function SignupModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex justify-center items-center">
      <div className="bg-[#3D3D3D] p-8 rounded-2xl w-[400px] relative  text-white shadow-2xl">
        {/* Close button */}
        <button onClick={onClose} className="absolute cursor-pointer top-4 right-4 text-white hover:scale-105 transition">
          <X size={20} />
        </button>

        <div className="text-center mb-4 text-[22px] font-['Playball']">Logo</div>
        <h2 className="text-center text-2xl font-bold mb-4">Sign up to Inkup</h2>
        ...
        <div className="flex flex-col gap-4">
          ...
          <AuthButton Icon={FiMail} label="Continue with Email" />
        </div>
